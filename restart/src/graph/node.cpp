...
template <typename T>
Node<T>::Node(const Node & other): _id(other._id), _type(other._type), _buffer(other._buffer),_status(other._status), _commDelay(other._commDelay) {};
